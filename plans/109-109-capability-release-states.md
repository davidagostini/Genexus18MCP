# Plan 109: Productize capability states and live-KB release gates
...
Evidence: `plans/README.md:8-13` lists pre-GA gates; `.github/workflows/live-smoke.yml:5-23` requires a KB/fixture on self-hosted Windows; `docs/technical_architecture.md:145-147` exposes `genexus://kb/capabilities`.

Define machine-readable states contract-tested, SDK-probed, live-KB-verified, and release-gated; surface them through SDK probe, capabilities resource, discovery metadata, and release reports. Specify stale evidence expiry and unsupported-capability behavior.

Scope: design/spike, manifest/schema, release/report examples. Out of scope: falsely upgrading status without live evidence.

Done: state model, provenance fields, promotion/demotion rules, CI integration proposal, and user-facing examples are complete.
