# Plan 108: Define safe typed visual authoring with feedback
...
Evidence: `docs/mcp-roadmap-ide-parity.md:33-53,61-84,137-170` lists layout/event/control/theme/preview gaps and explicitly excludes replacing visual design at `:206-210`.

Design the pipeline authoritative-surface detection → typed SDK mutation → schema/gotcha validation → optional browser evidence. Specify rollback, baseline preservation, pattern-license variability, and evidence format.

Scope: design/spike and acceptance corpus. Out of scope: full IDE replacement or unverified live implementation.

Done: boundary, typed contracts, validation stages, preview evidence, and live-KB gate are explicit.
