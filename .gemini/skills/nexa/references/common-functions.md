...
## HTMLClean
Returns well-formed XHTML from HTML

Syntax: `HTMLClean(<expression>)`
Method: `<expression>.HTMLClean()`
...
## GetEncryptionKey
Generates a new 32-character hexadecimal encryption key

Syntax: `GetEncryptionKey()`
Method: N/A
